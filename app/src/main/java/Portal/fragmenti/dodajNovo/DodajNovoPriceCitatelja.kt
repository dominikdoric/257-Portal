    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == CAMERA) {
                data?.let {
                    ...
                    binding.imageViewPriceCitatelja.setImageBitmap(thumbnail)

                    binding.addImagePriceCitatelja.setImageDrawable(
        ...
        if (requestCode == GALLERY) {
            data?.let {
                ...
                binding.imageViewPriceCitatelja.setImageURI(selectedPhotoUri)
